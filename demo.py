...
val_set = CACDDataset("./data/demo_demo.hdf5", val_transform, inv_normalize)
...
for i, data in tqdm(enumerate(dataloader), total=len(dataloader)):
    ...
    for j in range(recon_img.shape[0]):
        ...
        mesh.export("./demo_output/mesh"+str(i)+".ply")
        print ("==> Mesh export successfully")
        ...
        # imsave("./demo_output/rendered.png", recon_img[j])
        print ("==> Image rendered and saved successfully")
        plt.show()
        fig.savefig("./demo_output/result"+str(i)+".png")
